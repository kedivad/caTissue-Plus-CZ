...
{	
	/**
	 * Test case for Insert Dispose Specimen Event for closed Stav Aktivity.
	 */
	...
	/**
	 * Test case for Dispose Specimen Event for Disabled Stav Aktivity.
	 */
	public void testInsertDisposeSpecimenEventForDisabledStatus()
	 {
		 try
		 {
		       ...
		       if(Status.ACTIVITY_STATUS_DISABLED.toString().equals(disposalEvent.getSpecimen().getActivityStatus()))
		       {
		    	   assertTrue("Disposed event sucessfully fired: Stav Aktivity Disable :" + disposalEvent , true);
		       }
		       else
		       {
		    	   assertFalse("Disposed event Failed:" + disposalEvent , true);
