		...
		<html:hidden property="operation" styleId="operation" />
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
				<tr>
					...
					<input type="button" value="Odeslat" class="blue_ar_b" accesskey="A" onclick="submitForm()"/>
            	</logic:notEqual>
            	<logic:equal name="shipmentReceivingForm" property="activityStatus" value="<%=edu.wustl.catissuecore.util.shippingtracking.Constants.ACTIVITY_STATUS_RECEIVED%>">
					<input type="button" value="Odeslat" class="blue_ar_b" accesskey="A" disabled="true" onclick="submitForm()"/>
            	</logic:equal>
										</td>
									</tr>
								</table>
