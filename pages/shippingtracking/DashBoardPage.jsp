						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
      							<td valign="middle" class="tablepadding">
  											<html:button  property="createShipment" styleId="createShipment" styleClass="blue_ar_b" accesskey="createnewshipment" value="Vytvořit novou Zásilku" onclick="createNewShipment()"></html:button>
											&nbsp;<img src="images/shippingtracking/bl_sep.gif" width="1" height="19" align="absmiddle">&nbsp;
  											<html:button  property="createRequest" styleId="createRequest" styleClass="blue_ar_b" accesskey="createnewrequest" value="Vytvořit novou Žádost" onclick="createNewRequest()"></html:button>
											</td>
