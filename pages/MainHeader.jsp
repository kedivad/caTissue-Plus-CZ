		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<input type="hidden" id="tmp_usrName" value="${sessionData.firstName} ${sessionData.lastName}"/>
						<input class="form-text"  value="Rychlé vyhledávání vzorků, kontejnerů atd...."    type ="text" name = "searchString" id = "searchString" onkeypress="return titliOnEnter(event, this, document.getElementById('go'))" 
