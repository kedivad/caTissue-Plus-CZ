				...
				<td colspan="2" style="padding-top:10px; padding-bottom:15px;">
					<table summary="" cellpadding="4" cellspacing="0" border="0"  width="100%">
						<tr class="tableheading">
							...
							<th class="black_ar_b"> Strana odběru</th>
							<th class="black_ar_b"> Pathological Status</th>
							<th class="black_ar_b"> Storage</th>
							<th class="black_ar_b"> Qty</th>
						</tr>
					
			<md:genericSpecimenDetails columnHeaderListName="colHeaderListP" formName="viewSpecimenSummaryForm" dataListName="specimenList" dataListType="Základní" columnListName="colOrderListP" isReadOnly="true" displayColumnListName="displayColumnListP" />
...
<%-- 						<tr>
								...
								<th class="formSerialNumberLabelForTable" scope="col">Received</th>
									...
									<th class="formSerialNumberLabelForTable" scope="col"> Strana odběru</th>
