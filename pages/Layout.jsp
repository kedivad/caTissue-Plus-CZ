...
<script language="JavaScript">
        ...
        function warnBeforeSessionExpiry()
        {
            ...
            else
            {
                ...
                pvwindow=dhtmlmodal.open('Session Timeout', 'iframe', 'pages/SessionTimeOutWin.html','Upozornění na vypršení časového limitu relace', 'width=370px,height=115px,center=1,resize=0,scrolling=1');
            }
        }
...
<script type="text/javascript" charset="utf-8" src="jss/ajax.js"></script>
</html>
