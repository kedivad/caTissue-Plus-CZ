		...
		<TR>
			...
			<table border=0 width="100%">
				<md:specDetFormat4 columnHeaderListName="columnHeaderList"
					...
					dataListType="Základní" columnListName="columnListName"
	...
	<table align="bottom">
		...
		<tr>
			...
			<tr>
				<table border="0">
					<tr>
						<td><input class="blue_ar_b" type="button" value="Odeslat"
 ...
 %>
  <logic:equal name="IsToShowButton" value="true">
						<td>|&nbsp;<input class="blue_ar_b" type="button"  id="addToCart"
							value="Přidat na seznam vzorků" onclick="<%=organizeTarget%>" /></td>
							</logic:equal>
					</tr>
				</table>
			</tr>
