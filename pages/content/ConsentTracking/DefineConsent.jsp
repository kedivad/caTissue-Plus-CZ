...
<%-- Main table Start --%>
    ...
    <tr>
      <td colspan="2" class="buttonbg">
      	<html:button property="addButton" styleClass="blue_ar_b" onclick="addConsentTier()" value="Přidat další" accesskey="A"/>&nbsp;|
      	<html:button property="removeButton" styleClass="blue_ar_b" onclick="deleteSelected()" value="Odstranit"/>
	</td>
    </tr>
  </table>
<%-- Main table End --%>