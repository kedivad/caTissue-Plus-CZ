...
<script type="text/javascript" charset="utf-8" src="dhtmlxSuite_v35/dhtmlxGrid/codebase/dhtmlxcommon.js"></script>
<script type="text/javascript" charset="utf-8" src="dhtmlxSuite_v35/dhtmlxCalendar/codebase/dhtmlxcalendar.js"></script>
                                        ...
                                        <ul id="bioHazardList" class="tagEditor">
                                            <c:if test="${not empty specimenDTO.bioHazards}">
                                                    <c:forEach var="biohazard" items="${specimenDTO.bioHazards}">
                                                        <li id="li${biohazard.id}" title="Upravit">
                    ...
                    <td align="left" colspan="2" class="buttonbg">
                        <table cellpadding="0" cellspacing="0" border="0" id="specimenPageButton" width="100%"> 
                            <tr>
                                <td class="buttonbg">
                                <table><tr><td>
                                    <input type="button" id="specimenSubmitButton" value="Odeslat" onclick="submitTabData('${requestScope.operation}')" class="blue_ar_b"/>
                                    </td><td>
                                    <div id="specListDiv" style="display:none">
                                    | <input type="button" value="Přidat na seznam vzorků"
