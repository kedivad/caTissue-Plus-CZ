...
<script type="text/javascript" charset="utf-8" src="newDhtmlx/version3/dhtmlxGrid/dhtmlxgrid.js"></script>
<script type="text/javascript" charset="utf-8" src="newDhtmlx/version3/dhtmlxGrid/dhtmlxgridcell.js"></script>
<script type="text/javascript" charset="utf-8" src="newDhtmlx/version3/dhtmlxCombo/dhtmlxcombo.js"></script>
<script type="text/javascript" charset="utf-8" src="newDhtmlx/version3/dhtmlxGrid/excells/dhtmlxgrid_excell_combo.js"></script>
...
<script type="text/javascript" charset="utf-8" src="jss/tag-popup.js"></script>
<script type="text/javascript" charset="utf-8" src="jss/specimen.js"></script>
...
<script>
        ...
        function init_grid(){       
            ...
            aliquotGrid.setHeader("Label,Čárový kód,Množství,Skladovací kontejner <a style='margin-left:62px;' href='#' onclick='applyFirstToALL()'>Aplikovat první na vše</a>,Pozice 1,Pozice 2,Mapa kontejneru,");
        ...
        function onGridLoadSetAutoGenerated(grid_obj,rowCount){
            ...
            aliquotGrid.setColumnExcellType(0,"ro");
                ...
                {
                    grid_obj.cellByIndex(cnt,0).setValue("Generováno");
                }
            }
            else
            {
            ...
            aliquotGrid.setColumnExcellType(1,"ro");
                for(var cnt=1;cnt<grid_obj.getRowsNum();cnt++)
                {
                    grid_obj.cellByIndex(cnt,1).setValue("Generováno");
                }
            }
            else
            {
        ...
        function onGridLoad(grid_obj,rowCount){
            for(var cnt=1;cnt<grid_obj.getRowsNum();cnt++){
                grid_obj.cellByIndex(cnt,6).setValue("<a href='#' onclick='javascript:openMapPopUp(\""+cnt+"\");return false'><img src='images/uIEnhancementImages/grid_icon.png' alt='Displays the positions for the selected container'  width='16' height='16' border='0' style='vertical-align: middle' title='Zobrazit pozice pro vybraný kontejner'></a>&nbsp;<a href='#' onclick='javascript:openViewMap(\""+cnt+"\");return false'><img src='images/uIEnhancementImages/Tree.gif' border='0' width='16' height='16' style='vertical-align: bottom' title='Vybrat pozici z hierarchického zobrazení'/></a>");
...
function loadaliquotDetail(){
    ...
    if('${pageOf}'!='fromMenu'){
        ...
        document.getElementById("resubmitButton").value = "Odeslat";
    }
}
...
<div  width="100%" id="mainDiv" style="padding:5px;">
    ...
    <div width="100%"  class="tr_bg_blue1"  style="margin-top:6px;">
        ...
        <div width="100%"  class="black_ar"  style="margin-top:5px;">
            <div  style="float:left;text-align:right;width:30%;">
                <div  class="aliquot_details aliquot_form_label">
                    ...
                    <span  class="black_ar_b"><bean:message key="createSpecimen.parentLabel"/>/Čárový kód</span>
                </div>
                <div class="aliquot_details aliquot_form_label">
                    <span><img src="images/uIEnhancementImages/star.gif" alt="Mandatory" width="6" height="6" hspace="0" vspace="0" /></span>
        ...
        <div width="100%"   class="black_ar"  style="margin-top:5px;">
            <input type="button"  class="blue_ar_b" id="resubmitButton" value="Znovu odeslat"
                            onclick="onResubmit()">
    ...
    <div width="100%" id="aliquotDetailsDiv" style="display:none">
        ...
        <div width="100%"  id="successButtonDiv" class="black_ar"  style="margin-top:5px;"  style="display:none">
            <html:button
            styleClass="blue_ar_b" property="Add Events"
            title="Přidat na seznam vzorků"
            value="Přidat na seznam vzorků"
