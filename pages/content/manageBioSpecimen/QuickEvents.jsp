...
<link href="css/catissue_suite.css" rel="stylesheet" type="text/css" /> 
	...
	var defualtHelpText="Zadejte čárkami oddělený seznam labelů";
	...
	function showHelpText(fld)
	{
		...
		function onParameterChange(dropDownFld)
		{
			...
			if(specimenLabelText == defualtHelpText || specimenLabelText =="")
			{
				...
				document.forms[0].specimenEventParameter.value="-- Vybrat --";
			}
			else
			{
				if(selectedEvent !="-- Vybrat --")
				{
...
String defualtLabelText="Zadejte čárkami oddělený seznam labelů";
										...
										<table width="53%" border="0" cellspacing="0" cellpadding="0" >
											<tr >
												<td>
													...
													<%
														if(defualtLabelText.equals("Zadejte čárkami oddělený seznam labelů"))
														{
															%>
