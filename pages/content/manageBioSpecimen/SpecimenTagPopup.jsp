...
function checkForValidation()
{
	...
	if(displayStyle == "block")
	{
		...
		{
			alert("Prosím vyberte alespoň jednoho uživatele z nabídky");
		}
		else
		{
			ajaxShareTagFunctionCall("ShareTagAction.do","Vyberte alespoň jeden existující seznam.") 
		}
	}
}
...
Ext.onReady(function(){
	...
	var combo = new Ext.form.ComboBox({store: ds,hiddenName: 'CB_coord',displayField:'excerpt',valueField: 'id',typeAhead: 'false',pageSize:15,forceSelection: 'true',queryParam : 'query',mode: 'remote',triggerAction: 'all',minChars : 3,queryDelay:500,lazyInit:true,emptyText:'--Vybrat--',valueNotFoundText:'',selectOnFocus:'true',applyTo: 'coord'});
...
function setHeader(isSpecimenChecked)
{
	if(isSpecimenChecked == true){		 
		document.getElementById("poupHeader").textContent ="Přiřadit vzorek(y) na seznam";
		document.getElementById("poupHeader").innerText ="Přiřadit vzorek(y) na seznam";
	}else{
		document.getElementById("poupHeader").textContent ="Sdílet seznam(y) s uživatelem";
		...
		document.getElementById("poupHeader").innerText ="Sdílet seznam(y) s uživatelem";
	} 
}
						...
						cellpadding="0" border="0">
							<tr valign="center" height="35" bgcolor="#d5e8ff">
								<td width="27%" align="left"
									...
									<p>
									     <div id="poupHeader"><b> Seznam vzorků </b></div>
									</p>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td>	
									<p> 			
 										&nbsp&nbsp&nbsp
										<input type="button" id="assignButton" value="PŘIŘADIT" title="Přiřadit" onclick="assignTargetCallFunc()"
												onkeydown="assignTargetCallFunc()"  class="btn3">
				 
 										&nbsp&nbsp&nbsp
										<input type="button"  id="shareButton" value="SDÍLET SEZNAM" title="Sdílet seznam (Seznam bude viditelný pro Vámi vybrané uživatele)" onclick="checkForValidation()"
