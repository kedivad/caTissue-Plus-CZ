...
<html:form action="SpecimenCollectionGroupView.do" >
	...
	<table width="100%" border="0"  cellpadding="10" cellspacing="0"	class="whitetable_bg">	
		<tr class="tr_bg_blue1 blue_ar_b">
			...
			<td align="right">
				<html:button styleClass="blue_ar_b"	property="editSCG"	title="Edit Only" value="Upravit" onclick="showEditSCGPage()">
				</html:button> &nbsp;
				
				<html:button styleClass="blue_ar_b"	property="deleteSCG"	title="Jen Odstranit" value="Odstranit" >
				</html:button>
			</td>
		</tr>
		<tr class="bottomtd">
	...
	<table width="100%" border="0"  cellpadding="0" cellspacing="0"	class="whitetable_bg">
	   <tr height="33px">
		 <td  align="right" class="black_ar bottomtd  padding_right_style" width="25%"> 
			<b> Časový bod události v kalendáři studie </b>
		 </td> 
