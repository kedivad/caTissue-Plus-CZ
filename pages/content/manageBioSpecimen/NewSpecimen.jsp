			 ...
			 %>
				...
				<logic:equal name="<%=Constants.OPERATION%>" value="<%=Constants.VIEW%>">
					...
					<%
						...
						readOnlyForAll = true;
						if(form.getClassName().equals("Molekula")&& !(Constants.ALIQUOT).equals(form.getLineage()))
						{
									...
									<logic:notEqual name="<%=Constants.OPERATION%>" value="<%=Constants.ADD%>">
										<% if(showContainer!=null&&showContainer.equals("Pending"))
										{
												...
												<tr>
														...
														<input type="text" size="30" maxlength="255"  class="black_ar"  value='<%=specimenPositionAsString.toString()%>' readonly style="border:0px" id="storageContainerPosition" /> <input type="button" class="blue_ar_b" value="Upravit" onclick="loadDHTMLXWindowForTransferEvent()" />
														</td>
