...
<div id="contextmenu" class="skin0" onMouseover="highlight(event)" onMouseout="lowlight(event)" onClick="jumptomain(event)" display:none>
		<div class="menuitems" url="javascript:alert('Not Implemented');">Upravit</div>
		<div class="menuitems" url="javascript:alert('Not Implemented');">Kopírovat</div>
		<div class="menuitems" url="javascript:alert('Not Implemented');">Vložit</div>
		<div class="menuitems" url="javascript:alert('Not Implemented');">Odstranit</div>
		<div class="menuitems" url="javascript:onSelectAll();">Vybrat vše</div>
</div>
