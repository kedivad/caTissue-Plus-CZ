...
<c:if test="${indx > 0}">
    ...
    <!--tr class="tr_alternate_color_lightGrey">
            <td width="20%" align="right" class="black_ar padding_right_style">
                <html:button  styleClass="blue_ar_b"    property="editParticipant"  title="Edit Only" value="Upravit"  onclick="showEditPage()">
                </html:button>
            </td>
            <td width="20%">
        ...
        <tr class="tr_bg_blue1 blue_ar_b">
            ...
            <td width="35%" class="black_ar">   
             <span style="vertical-align:bottom">
                ...
                <a href="#" title="Odstranit"><img src="images/Action-close.png" alt="Delete" onclick="scgOperation('delete')"></a> &nbsp;
...
<tr class="tr_alternate_color_lightGrey">   
            <td width="20%" class="black_ar padding_right_style"> 
                <span style="float:left"  class="blue_ar_b"><b>NEBO</b></span>
            ...
            <td width="35%" class="black_ar">   
             <span style="vertical-align:bottom">
                ...
                <a href="javascript:editScg()" title="Upravit" style="padding-right:7px;"><bean:message key="label.editSCG"/></a>
            ...
            <tr ><td>
                  <div id="myinnercontainer"><span>
                     <input type="radio" value="1" id="multipleChk" name="specimenChild" onclick="disableButtonsOnCheck(this)" checked="true" style="vertical-align: middle;margin-bottom:1px;"/>
                                ...
                                <label style="vertical-align: middle;">Plánovaně</label>
                                </span></span>
                        ...
                        <input type="radio" value="2" id="multipleChk" name="specimenChild" onclick="disableButtonsOnCheck(this)" style="vertical-align: middle;margin-bottom:1px"/>
                                <span style="font-family: verdana;font-size: 11px;">
                                <label style="vertical-align: middle;">Neplánovaně</label>
                        </span></span>
                ...
                <td width="35%">
                        <span align="left">
                        <html:button  styleClass="blue_ar_b" property="aliquot" title="Alikvóty" value="Pokračovat" onclick="createNewSpecimens()">
                </html:button>
                        </span>
</td>
            </tr>
...
<tr> <td colspan="4"></td> </tr>
    ...
    <tr>    
        ...
        <td width="25%" class="black_ar">       
            <span style="vertical-align:bottom">
                <a href="javascript:editSpecimen()" title="Upravit"><bean:message key="specimen.edit.title"/></a>&nbsp;
    ...
    <tr width="100%" class="tr_alternate_color_lightGrey">
        ...
        <td width="25%" >
            <input type="text" name="noOfAliquots" id="noOfAliquots" size ="5" value="Počet"  class="text_box_style" onfocus="inputFocus(this)" onblur="inputBlur(this)"/>
                        
            <input type="text" name="quantityPerAliquot" id="quantityPerAliquot" size ="5" value="Množství" class="text_box_style" onfocus="inputFocus(this)" onblur="inputBlur(this)"/>
        </td>
        <td width="25%" >
                <html:button  styleClass="blue_ar_b" property="aliquot" title="Alikvóty" value="Pokračovat" onclick="createAliquote()">
                </html:button>
    ...
    <tr>
        ...
        <td width="25%">
             <input type="text" name="count" id="derivative_count" size ="5" value="Počet" class="text_box_style" onfocus="inputFocus(this)" onblur="inputBlur(this)"/>
        </td>
        <td width="25%">
                <html:button  styleClass="blue_ar_b" property="derivative" title="Derivát" onclick="createDerivative()" value="Pokračovat">
                </html:button>
