...
<html:form action='${requestScope.formName}'>
	...
	<html:hidden property="specimenId" value='${requestScope.specimenId}'/>
        ...
        <tr >
          <td class="buttonbg">
			<html:submit styleClass="blue_ar_b" value="Odeslat" property="Submit" onclick="return confirmAction(this.form)"/>
						 &nbsp;|&nbsp;
		  <html:button styleClass="blue_ar_b" value="Odstranit" property="disable" onclick='${requestScope.deleteAction}'/>
			</td>
