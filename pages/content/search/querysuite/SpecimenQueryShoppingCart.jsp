...
<script type="text/javascript" charset="utf-8" src="dhtmlx_suite/gridexcells/dhtmlxgrid_excell_combo.js"></script>
...
function deleteList()
{
	var flag = confirm("Opravdu chcete odstranit vybrené položky?");
				if(flag)
				{
...
function onSubmit(orderedString)
{
	...
	{
		if(document.getElementById('specimenEventParameter').value == "Přemístění")
		{
...
function onDelete()
		...
		request.send(actionURL);
			...
			{
				alert("Prosím zaškrtněte alespoň jedno políčko");
			}
		}
...
function loadSpecimenGrid()
{
	...
	mygrid.setHeader(",Název Kolekce sesbíraných vzorků,Label (Čárový kód),,Label nadřazeného vzorku,Třída (Typ),,Množství,Rodokmen,,");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
  <tr>
    <td class="td_color_bfdcf3"><table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td class="td_table_head"><span class="wh_ar_b">Seznam vzorků</span></td>
	...
	<td width="75%">
		...
		<tr>
			<td class="black_ar" colspan="2">
				<label><b>Vyberte seznam k zobrazení:<b></label>
					...
					if(labelList !=null && labelList.size() > 0)
		{
			...
			<%
 						String	organizeTarget = "shareSpecimenList('Opravdu chcete položku odstranit?','AOpravdu chcete položku odstranit?','SpecimenListTag','SpecimenListTagItem')";
 			%>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="    Odstranit seznam     " onClick="deleteList()"/>
				<input type="button" value="    Sdílet seznam     " onClick="<%=organizeTarget %>"/>
			</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="1" cellspacing="0">
          <tr>
		   ...
		   <td class="black_ar" width="33%">
			   ...
			   <autocomplete:AutoCompleteTag  property="specimenEventParameter" 
						  ...
						  initialValue="Přemístění"/>
				 </div> 
		     
			   <div id="eventlist2" style="display:block"><input type="text" styleClass="black_ar" size="25" id="specimenEventParameter1" name="specimenEventParameter" value="Přemístění" readonly="true"/></div>
             </td>
		  </tr>
          ...
          <tr>
            ...
            <td class="black_ar" >Distribuovat</td>
	...
	<tr>
	 ...
	 <tr>
		<td class="messagetextsuccess">&nbsp;
			Nejsou k dispozici žádné uložené seznamy vzorků. Prosím použijte stránku s výsledky rozšířeného dotazu nebo stránku se sběrem vzorků k vytvoření nového seznamu vzorků.
		</td>
	</tr>
	<tr>
		<td class="bottomtd"></td>
