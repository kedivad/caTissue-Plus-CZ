...
<script language="JavaScript" type="text/javascript" src="jss/javaScript.js"></script>
	...
	<script language="JavaScript">
		...
		//This function enables the concentration fields if the class name selected is "Molekula" &
		...
		function afterChange(element)
		{
			...
			{
				if(classCombo.options[classCombo.selectedIndex].text == "Molekula")
				{
					concCombo.disabled = false;
				}
	...
	<script language="JavaScript">
		...
		function addMore(divTag)
		{
			...
			sname = "<select name='eventMap(" + comboName + ")' size='1' onchange='"+functionName+"' class='formFieldSized15' id='" + comboName + "' onmouseover=showTip(this.id) onmouseout=hideTip(this.id)><option value='-1'>-- Vybrat --</option></select>";
...
<!-- Mandar : 434 : for tooltip -->
	...
	<%
		...
		/*if(!disabled)
		{
			disabled = (classValue != null && classValue.equals("Buňka"));
		}*/
...
<tr>
	...
	<%
		...
		if(classValue != null && classValue.equals("Molekula") && opValue.equals(Operator.EQUALS_CONDITION))
		{
