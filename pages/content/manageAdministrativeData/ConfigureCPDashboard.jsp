							...
							<table summary="" cellpadding="3" cellspacing="0" border="0" width="100%">
								<tr>
									<td colspan="6" align="left" class="tr_bg_blue1" width="90%">
									     <span id="mesgSpan" class="black_new"><b>* Editace dvojkliknutím na řádek</b></span>
		                                                         					 
									</td>
									<td align="right" class="tr_bg_blue1" width="5%">
									<html:button property="addSpecimenReq" styleClass="black_new" styleId="addSpecimenReq" value="Přidat další" onclick="addCSLevelFormRow()"/>
									</td>
									<td class="tr_bg_blue1" align="Vpravo" width="5%">
