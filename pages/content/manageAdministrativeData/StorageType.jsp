...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	...
	<script>
		Ext.onReady(function(){var myUrl= 'SpecimenTypeDataAction.do?method=Tkan';var ds = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: myUrl}),reader: new Ext.data.JsonReader({root: 'row',totalProperty: 'totalCount',id: 'id'}, [{name: 'id', mapping: 'id'},{name: 'excerpt', mapping: 'field'}])});var combo = new Ext.form.ComboBox({store: ds,hiddenName: 'CB_tissue',displayField:'excerpt',valueField: 'id',typeAhead: 'false',pageSize:15,forceSelection: 'true',queryParam : 'query',mode: 'remote',triggerAction: 'all',minChars : 3,queryDelay:500,lazyInit:true,emptyText:'--Vybrat--',valueNotFoundText:'',selectOnFocus:'true',applyTo: 'tissue'});combo.on("expand", function() {if(Ext.isIE || Ext.isIE7){combo.list.setStyle("width", "250");combo.innerList.setStyle("width", "250");}else{combo.list.setStyle("width", "auto");combo.innerList.setStyle("width", "auto");}}, {single: true});});
	</script>

	<script>Ext.onReady(function(){var myUrl= 'SpecimenTypeDataAction.do?method=Kapalina';var ds = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: myUrl}),reader: new Ext.data.JsonReader({root: 'row',totalProperty: 'totalCount',id: 'id'}, [{name: 'id', mapping: 'id'},{name: 'excerpt', mapping: 'field'}])});var combo = new Ext.form.ComboBox({store: ds,hiddenName: 'CB_fluid',displayField:'excerpt',valueField: 'id',typeAhead: 'false',pageSize:15,forceSelection: 'true',queryParam : 'query',mode: 'remote',triggerAction: 'all',minChars : 3,queryDelay:500,lazyInit:true,emptyText:'--Vybrat--',valueNotFoundText:'',selectOnFocus:'true',applyTo: 'fluid'});combo.on("expand", function() {if(Ext.isIE || Ext.isIE7 || Ext.isSafari3){combo.list.setStyle("width", "250");combo.innerList.setStyle("width", "250");}else{combo.list.setStyle("width", "auto");combo.innerList.setStyle("width", "auto");}}, {single: true});});</script>

	<script>Ext.onReady(function(){var myUrl= 'SpecimenTypeDataAction.do?method=Bunka';var ds = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: myUrl}),reader: new Ext.data.JsonReader({root: 'row',totalProperty: 'totalCount',id: 'id'}, [{name: 'id', mapping: 'id'},{name: 'excerpt', mapping: 'field'}])});var combo = new Ext.form.ComboBox({store: ds,hiddenName: 'CB_cell',displayField:'excerpt',valueField: 'id',typeAhead: 'false',pageSize:15,forceSelection: 'true',queryParam : 'query',mode: 'remote',triggerAction: 'all',minChars : 3,queryDelay:500,lazyInit:true,emptyText:'--Vybrat--',valueNotFoundText:'',selectOnFocus:'true',applyTo: 'cell'});combo.on("expand", function() {if(Ext.isIE || Ext.isIE7 ||  Ext.isSafari3){combo.list.setStyle("width", "250");combo.innerList.setStyle("width", "250");}else{combo.list.setStyle("width", "auto");combo.innerList.setStyle("width", "auto");}}, {single: true});});</script>

	<script>Ext.onReady(function(){var myUrl= 'SpecimenTypeDataAction.do?method=Molekula';var ds = new Ext.data.Store({proxy: new Ext.data.HttpProxy({url: myUrl}),reader: new Ext.data.JsonReader({root: 'row',totalProperty: 'totalCount',id: 'id'}, [{name: 'id', mapping: 'id'},{name: 'excerpt', mapping: 'field'}])});var combo = new Ext.form.ComboBox({store: ds,hiddenName: 'CB_molecular',displayField:'excerpt',valueField: 'id',typeAhead: 'false',pageSize:15,forceSelection: 'true',queryParam : 'query',mode: 'remote',triggerAction: 'all',minChars : 3,queryDelay:500,lazyInit:true,emptyText:'--Vybrat--',valueNotFoundText:'',selectOnFocus:'true',applyTo: 'molecular'});combo.on("expand", function() {if(Ext.isIE || Ext.isIE7 || Ext.isSafari3){combo.list.setStyle("width", "250");combo.innerList.setStyle("width", "250");}else{combo.list.setStyle("width", "auto");combo.innerList.setStyle("width", "auto");}}, {single: true});});</script>
  ...
  <tr>
	...
	<!-- for tabs selection -->
      ...
      <table width="100%" border="0" cellpadding="3" cellspacing="0" class="whitetable_bg">
          ...
          <td colspan="2" align="left" class="showhide"><table width="100%" border="0" cellpadding="3" cellspacing="0">
                ...
                <tr class="black_ar">
                        <td width="1%" align="center" valign="top" class="black_ar"><img src="images/uIEnhancementImages/star.gif" alt="Mandatory" width="6" height="6" hspace="0" vspace="3" /></td>
						 <td  align="left" valign="top" class="black_ar"><label for="Dimension One labelling scheme" onmouseover="Tip('Dimension One labelling scheme')">Schéma označení Prvního rozměru</label>
						 <td class="black_ar"><html:select  styleClass="formFieldSizedNew" property="oneDimensionLabellingScheme" size="1" style="width:145px"><html:options collection="labellingSchemeList"labelProperty="name" property="value"  /></html:select>
						  &nbsp;&nbsp;&nbsp;&nbsp;<img src="images/uIEnhancementImages/star.gif" alt="Mandatory" width="6" height="6" hspace="0" vspace="0" />
						<label for="Dimension Two labelling scheme" onmouseover="Tip('Dimension Two labelling scheme')">Schéma označení Druhého rozměru</label>
        ...
        <tr>
          <td colspan="2" class="buttonbg"><html:button styleClass="blue_ar_b" property="submitPage" title="Jen odeslat"
										value='${requestScope.submit}' onclick='selectSpType(),${requestScope.normalSubmit}'>
									</html:button>
            &nbsp;
            |&nbsp;
                      <html:button styleClass="blue_ar_b" property="storageContainerPage" title="Odeslat a Přidat kontejner" value='${requestScope.addContainer}'
