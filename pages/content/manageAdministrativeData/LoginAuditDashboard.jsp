...
<script type="text/javascript" charset="utf-8" src="jss/advQuery/json2.js"></script>
...
window.onload = function() {   
    ...
    auditGridBox.setHeader("<b>Uživatelské jméno,<b>IP adresa,<b>Časové razítko,<b>Pokus o přihlášení");
