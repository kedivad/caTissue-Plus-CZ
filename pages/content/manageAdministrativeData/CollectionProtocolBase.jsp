    ...
    <td class="tablepadding"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <logic:equal parameter="operation"	value='add'>
                    ...
                    <td valign="bottom" ><html:link page="/SimpleQueryInterface.do?pageOf=pageOfCollectionProtocol&aliasName=CollectionProtocol"><img src="images/uIEnhancementImages/tab_edit_notSelected.jpg" alt="Edit" width="59" height="22" border="0" /></html:link></td>
					</logic:equal>
					<logic:equal parameter="operation"	value='edit'>
					<td valign="bottom" ><html:link page="/OpenCollectionProtocol.do?pageOf=pageOfmainCP&operation=add"><img src="images/uIEnhancementImages/tab_add_notSelected.jpg" alt="Add" width="57" height="22" /></html:link></td>
...
<logic:notEqual name="isSyncOn" value="true">
					 ...
					 <html:button styleClass="blue_ar_b" styleId="saveCPButton" property="forwardPage" value="Uložit" onclick="submitCP()">
					</html:button>
					<logic:equal parameter="operation"	value='edit'>
