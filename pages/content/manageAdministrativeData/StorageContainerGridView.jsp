...
function updatePosition(contId,containerName,pos1,pos2)
{
	...
	function setTextBoxValueForNewAliquot(elementId, elementValue, pos1, pos2) {
		parent.opener.setNewStoragePositionForAliquot(elementId, elementValue
				.replace('+', ' '), pos1, pos2);
	}
...
%>                 
		<tr>
          <td  align="left" class="tr_bg_blue1"><span class="blue_ar_b"> Omezení pro skladovací kontejner</span></td>
          </tr>
                  <tr>
					<td>
					  <table  border="0" cellspacing="0" cellpadding="0" width="100%"> 
						   	<td width="150">
								<table  border="0" cellspacing="2"  cellpadding="3" width="100%"> 
									<tr>
							<td  width="150" class="tabletd1">Protokol sběru</td>
							</tr>
								</table>
							</td>
							 <td>
						 ...
						 <table  border="0" cellspacing="0" cellpadding="0" width="100%"> 
						   <tr>
							<td width="150">
								<table  border="0" cellspacing="2"  cellpadding="3" width="100%"> 
									<tr>
											<td width="150" class="tabletd1">Třída vzorku</td>
									</tr>
								</table>
							</td>
							 <td>
					 ...
					 <table  border="0" cellspacing="0" cellpadding="0">
						 <tr>
							<td>
								<table  border="0" cellspacing="2"  cellpadding="3"> 
									<tr>
											<td width="140" class="tabletd1">Typ vzorku</td>
												<%	
