	...
	OPEN c_data;
  	FETCH c_data INTO RELATIONSHIPID;
	  	IF c_data%NOTFOUND THEN
			...
			INSERT INTO CATISSUE_SEARCH_DISPLAY_DATA (RELATIONSHIP_ID, COL_ID, DISPLAY_NAME, DEFAULT_VIEW_ATTRIBUTE, ATTRIBUTE_ORDER) VALUES (131, 72 , 'Distribuované množství', 0, 10);
