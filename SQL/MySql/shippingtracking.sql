...
insert into CATISSUE_SITE 
	...
	('In Transit','Repozitář','admin@admin.com',1,'Active',1);
...
insert into CATISSUE_STOR_TYPE_SPEC_CLASS
	...
	((select Max(IDENTIFIER) from CATISSUE_STORAGE_TYPE),'Kapalina');

insert into CATISSUE_STOR_TYPE_SPEC_CLASS 
	(STORAGE_TYPE_ID,SPECIMEN_CLASS) values 
	((select Max(IDENTIFIER) from CATISSUE_STORAGE_TYPE),'Tkáň');

insert into CATISSUE_STOR_TYPE_SPEC_CLASS 
	(STORAGE_TYPE_ID,SPECIMEN_CLASS) values 
	((select Max(IDENTIFIER) from CATISSUE_STORAGE_TYPE),'Molekula');

insert into CATISSUE_STOR_TYPE_SPEC_CLASS 
	(STORAGE_TYPE_ID,SPECIMEN_CLASS) values 
	((select Max(IDENTIFIER) from CATISSUE_STORAGE_TYPE),'Buňka');
