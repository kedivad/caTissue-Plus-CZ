...
insert into CATISSUE_SITE 
  ...
  (CATISSUE_SITE_SEQ.NEXTVAL,'In Transit','Repozitář','admin@admin.com',1,'Active');
...
insert into catissue_stor_type_spec_class 
  ...
  (CATISSUE_CONTAINER_TYPE_SEQ.CURRVAL,'Kapalina');

insert into catissue_stor_type_spec_class 
  (STORAGE_TYPE_ID,SPECIMEN_CLASS) values 
  (CATISSUE_CONTAINER_TYPE_SEQ.CURRVAL,'Tkáň');

insert into catissue_stor_type_spec_class 
  (STORAGE_TYPE_ID,SPECIMEN_CLASS) values 
  (CATISSUE_CONTAINER_TYPE_SEQ.CURRVAL,'Molekula');

insert into catissue_stor_type_spec_class 
  (STORAGE_TYPE_ID,SPECIMEN_CLASS) values 
  (CATISSUE_CONTAINER_TYPE_SEQ.CURRVAL,'Buňka');
