...
//				}
				...
				// Bug 1915:SpecimenCollectionGroup.Časový bod události v kalendáři studie not
			...
			if (forwardToHashMap != null
					|| (specimenCollectionGroupForm.getName() != null && specimenCollectionGroupForm
							.getName().equals(""))
					|| (resetName != null && resetName.equals("Ano")) || "participantView".equals(request.getParameter("requestFrom")))
			{
								...
								.equals(""))))
				{
					...
					// the id
							...
							&& (resetName != null && resetName.equals("Ano")))
					{
