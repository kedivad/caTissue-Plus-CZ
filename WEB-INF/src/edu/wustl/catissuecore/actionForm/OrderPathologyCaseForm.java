...
public class OrderPathologyCaseForm extends AbstractActionForm
{
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request)
	{
		...
		if (this.selectedItems != null)
		{
			...
			{
				if (this.className.equals("-1") || this.className.equals("-- Vybrat --")
				...
				if (this.type.equals("-1") || this.type.equals("-- Vybrat --")
						|| this.type.equals(""))
				{
			...
			{
				if (!this.addToArray.equalsIgnoreCase("None") && defineArrayFormObj != null
						&& !defineArrayFormObj.getArrayClass().equals("Tkáň"))
				{
					errors.add("addToArray", new ActionError("errors.order.properclass"));
					this.values.clear();
				}
			...
			if (this.pathologicalStatus.equals("-1")
					|| this.pathologicalStatus.equals("-- Vybrat --"))
			{
				errors.add("pathologicalStatus", new ActionError(
						"errors.pathologicalStatus.required"));
				this.values.clear();
			}
			if (this.tissueSite.equals("-1") || this.tissueSite.equals("-- Vybrat --"))
			{
