...
public class ExportCollectionProtocolBizLogic extends CatissueDefaultBizLogic
{
			...
			throws BizLogicException
	{
		...
		//headerDataMap.put("Stav Aktivity",collectionProtocol.getActivityStatus());
		headerString.append("Stav Aktivity").append(",");
		...
		for (CollectionProtocolEvent collectionProtocolEvent : eventsList)
		{
					...
					.getActivityStatus()))
			{
				...
				headerString.append("Označení časového bodu#")
						.append(eventsCount).append(",");
				valueString
						.append("\"")
						.append(collectionProtocolEvent
				...
				for (SpecimenRequirement specimenRequirement : requirementsList)
				{
											...
											.getActivityStatus()))
					{
						...
						//headerDataMap.put("Strana odběru"+postfix+"#"+childSpecimenCount,abstractSpecimen.getSpecimenCharacteristics().getTissueSide());
						headerString.append("Strana odběru#").append(eventsCount)
								.append("#").append(specimenRequirementCount)
								.append(",");
						valueString
								.append("\"")
			...
			String postfix)
	{
		...
		for (Object abstractSpecimen : requirementsList)
		{
							...
							.getActivityStatus()))
			{
				...
				//headerDataMap.put("Strana odběru"+postfix+"#"+childSpecimenCount,abstractSpecimen.getSpecimenCharacteristics().getTissueSide());
				headerString.append("Strana odběru").append(postfix).append("#")
						.append(childSpecimenCount).append(",");
				valueString
						.append("\"")
						.append(((SpecimenRequirement) abstractSpecimen)
