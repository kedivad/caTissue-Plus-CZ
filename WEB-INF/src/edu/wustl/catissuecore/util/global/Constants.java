...
public class Constants
{
	...
	public static final String SELECT_OPTION = "-- Vybrat --";
	...
	public static final String NOT_APPLICABLE = "Nelze použít";
...
//	public static final String DATE_PATTERN_YYYY_MM_DD = "yyyy-MM-dd";
	...
	public static final String REPOSITORY = "Repozitář";
	...
	public static final String[] CP_ASSOCIATION_TYPE_VALUES = {"Základní", "Fáze", "Větev", "Cyklus"};
	...
	public static final String DEFAULT_ASSOCIATION_TYPE = "Základní";
	...
	/** The Constant TISSUE. */
	public static final String TISSUE = "Tkáň";

	/** The Constant FLUID. */
	public static final String FLUID = "Kapalina";

	/** The Constant CELL. */
	public static final String CELL = "Buňka";

	/** The Constant MOLECULAR. */
	public static final String MOLECULAR = "Molekula";
	...
	public static final String CDE_NAME_TISSUE_SIDE = "Strana odběru";
	...
	public static final String EVENT_PARAMETERS[] = {Constants.SELECT_OPTION,
			"Revize buněčného vzorku", "Zapsání / Odhlášení", "Sběr", "Likvidace", "Usazení",
			"Fixace", "Revize kapalného vzorku", "Zmražení", "Revize molekulárního vzorku", "Zpracování",
			"Received", "Rotace", "Tání", "Revize buněčného vzorku", "Přemístění"};
	public static final String QUICK_EVENT_PARAMETERS[] = {Constants.SELECT_OPTION,
		"Revize buněčného vzorku", "Zapsání / Odhlášení", "Sběr", "Likvidace", "Usazení",
		"Fixace", "Revize kapalného vzorku", "Zmražení", "Revize molekulárního vzorku", "Zpracování",
		"Received", "Rotace", "Tání", "Revize buněčného vzorku"};
	...
	public static final String[] SHOPPING_CART_COLUMNS = {"", "Identifier", "Type", "Subtype",
			"Tissue Site", "Strana odběru", "Pathological Status"};
	...
	public static final String FROZEN_TISSUE_BLOCK = "Blok zmražené tkáně"; // PREVIOUS FROZEN BLOCK

	/** The Constant FROZEN_TISSUE_SLIDE. */
	public static final String FROZEN_TISSUE_SLIDE = "Zmražená Tkáň na sklíčku"; // SLIDE

	/** The Constant FIXED_TISSUE_BLOCK. */
	public static final String FIXED_TISSUE_BLOCK = "Blok fixní tkáně"; // PARAFFIN BLOCK

	/** The Constant NOT_SPECIFIED. */
	public static final String NOT_SPECIFIED = "Nespecifikováno";

	/** The Constant WITHDRAWN. */
	public static final String WITHDRAWN = "Odstoupeno";
	// tissue types with unit= g
	/** The Constant FRESH_TISSUE. */
	public static final String FRESH_TISSUE = "Čerstvá Tkáň";

	/** The Constant FROZEN_TISSUE. */
	public static final String FROZEN_TISSUE = "Zmražená Tkáň";

	/** The Constant FIXED_TISSUE. */
	public static final String FIXED_TISSUE = "Fixní Tkáň";

	/** The Constant FIXED_TISSUE_SLIDE. */
	public static final String FIXED_TISSUE_SLIDE = "Fixní Tkáň na sklíčku";
	//tissue types with unit= cc
	/** The Constant MICRODISSECTED. */
	public static final String MICRODISSECTED = "Mikrodisekce";
	...
	public static final String SELECTED_COLUMNS[] = {"Print : Specimen",
			...
			"SpecimenCharacteristics.TISSUE_SIDE.Strana odběru : Specimen",
	...
	public static final String UNKNOWN = "Neznámo";

	/** The Constant UNSPECIFIED. */
	public static final String UNSPECIFIED = "Nespecifikováno";

	/** The Constant NOTSPECIFIED. */
	public static final String NOTSPECIFIED = "Nespecifikováno";
	...
	public static final String[][] SPECIMEN_FORWARD_TO_LIST = {{"Odeslat", "success"},
			{"Odvodit", "createNew"}, {"Přidat události", "eventParameters"},
			{"Více", "sameCollectionGroup"}, {"Distribuovat", "distribution"},
			{"Odvodit více", "deriveMultiple"}};

	/** The Constant SPECIMEN_BUTTON_TIPS. */
	public static final String[] SPECIMEN_BUTTON_TIPS = {"Odeslat(jen)", "Odeslat a odvodit",
			"Odeslat a přidat události", "Odeslat a Přidat další do této skupiny", "Odeslat a distrubuovat",
			"Odeslat a odvodit více"};
	...
	public static final String[][] SPECIMEN_COLLECTION_GROUP_FORWARD_TO_LIST = {
			{"Odeslat", "success"}, {"Přidat vzorek", "createNewSpecimen"},
			{"Přidat vícenásobný vzorek", "createMultipleSpecimen"}};

	/** The Constant PROTOCOL_REGISTRATION_FORWARD_TO_LIST. */
	public static final String[][] PROTOCOL_REGISTRATION_FORWARD_TO_LIST = {{"Odeslat", "success"},
			{"Skupina sběru vzorků", "createSpecimenCollectionGroup"}};

	/** The Constant PARTICIPANT_FORWARD_TO_LIST. */
	public static final String[][] PARTICIPANT_FORWARD_TO_LIST = {{"Odeslat", "success"},
			{"Odeslat", "createParticipantRegistration"},
			{"Skupina sběru vzorků", "specimenCollectionGroup"},
			{"Odeslat", "pageOfParticipantCPQuery"}

	};

	/** The Constant STORAGE_TYPE_FORWARD_TO_LIST. */
	public static final String[][] STORAGE_TYPE_FORWARD_TO_LIST = {{"Odeslat", "success"},
			{"Přidat kontejner", "storageContainer"}};
	...
	public static final String ADVANCED_QUERY_ADD = "Přidat";

	/** The Constant ADVANCED_QUERY_EDIT. */
	public static final String ADVANCED_QUERY_EDIT = "Upravit";

	/** The Constant ADVANCED_QUERY_DELETE. */
	public static final String ADVANCED_QUERY_DELETE = "Odstranit";
	...
	public static final String BOOLEAN_YES = "Ano";

	/** The Constant BOOLEAN_NO. */
	public static final String BOOLEAN_NO = "Ne";
	...
	//public static final String SPECIMEN_TYPE_TISSUE = "Tkáň";
	//public static final String SPECIMEN_TYPE_FLUID = "Kapalina";
	//public static final String SPECIMEN_TYPE_CELL = "Buňka";
	//public static final String SPECIMEN_TYPE_MOL = "Molekula";
	...
	public static final String HOLDS_ANY = "--Vše--";
	...
	//	}
	/** The Constant ALL. */
	public static final String ALL = "Vše";
	...
	public static final String[] MULTIPLE_SPECIMEN_FIELD_NAMES = {"Collection Group", "Parent ID",
			"Name", "Barcode", "Class", "Type", "Tissue Site", "Strana odběru",
	...
	*//** Specify the SPECIMEN_ARRAY_LIST as key for specimen array type list. */
	...
	public static final int ALL_STORAGE_TYPE_ID = 1; //Constant for the "Vše" storage type, which can hold all container type

	/** The Constant ALL_SPECIMEN_ARRAY_TYPE_ID. */
	public static final int ALL_SPECIMEN_ARRAY_TYPE_ID = 2;//Constant for the "Vše" storage type, which can hold all specimen array type
	...
	public static final String[] CONFLICT_FILTER_LIST = {"Vše", "Nejednoznační Pacienti",
			"Nejednoznačné Skupiny sběru vzorků"};
...
//	};
	...
	public static final String CP_TYPE_PARENT = "Základní";

	/** The Constant ARM_CP_TYPE. */
	public static final String ARM_CP_TYPE = "Větev";

	/** The Constant PHASE_CP_TYPE. */
	public static final String PHASE_CP_TYPE = "Fáze";

	/** The Constant CYCLE_CP_TYPE. */
	public static final String CYCLE_CP_TYPE = "Cyklus";
	...
	public static final String REPO_SITE = "Repozitář";

	/** The Constant LAB_SITE. */
	public static final String LAB_SITE = "Laboratoř";

	/** The Constant COL_SITE. */
	public static final String COL_SITE = "Místo sběru";
	...
	public static final String MOLECULE = "Molekula";
...
//	public static final String DATE_PATTERN_MM_DD_YYYY = "MM-dd-yyyy";
	...
	public static final String LABELLING_SCHEME_ALPHABETS_UPPER_CASE="Velká písmena abecedy";
	public static final String LABELLING_SCHEME_ALPHABETS_LOWER_CASE="Malá písmena abecedy";
	public static final String LABELLING_SCHEME_ROMAN_UPPER_CASE="Velké Římské číslice";
	public static final String LABELLING_SCHEME_ROMAN_LOWER_CASE="Malé Římské číslice";
	public static final String LABELLING_SCHEME_NUMBERS="Čísla";
