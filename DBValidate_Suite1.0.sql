...
select count(*) from catissue_specimen sp where specimen_class like 'Tkáň' and sp.IS_COLL_PROT_REQ=0;
select count(*) from catissue_specimen sp where specimen_class like 'Buňka' and sp.IS_COLL_PROT_REQ=0;
select count(*) from catissue_specimen sp where specimen_class like 'Kapalina' and sp.IS_COLL_PROT_REQ=0;
select count(*) from catissue_specimen sp where specimen_class like 'Molekula' and sp.IS_COLL_PROT_REQ=0;
