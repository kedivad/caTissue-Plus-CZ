...
select count(*) from catissue_specimen where specimen_class like 'Tkáň';
select count(*) from catissue_specimen where specimen_class like 'Buňka';
select count(*) from catissue_specimen where specimen_class like 'Kapalina';
select count(*) from catissue_specimen where specimen_class like 'Molekula';
