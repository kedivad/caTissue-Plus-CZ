		...
		*/
		...
		function validateRegDate(param){
			...
			function loadParticipantTabbar(operation)
			{
				...
				participantTabbar.addTab("editParticipantTab",'<span style="font-size:13px"> Upravit pacienta </span>', "150px");
				
				if(reportId1 != null && reportId1 != -1  && reportId1 != -2)
				{
					participantTabbar.addTab("reportsTab",'<span style="font-size:13px"> Zobrazit Report(y) </span>', "150px");
				}
				participantTabbar.addTab("annotationTab",'<span style="font-size:13px">Zobrazit Anotace </span>',"150px");
				if(hasConsent){
				participantTabbar.addTab("consentsTab",'<span style="font-size:13px"> Souhlasy  </span>',"150px");
				}
