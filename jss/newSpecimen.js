...
function loadSpecimenTabbarForEdit()
{
	...
	specimenTabbar.addTab("specimenDetailsTab",'<span style="font-size:13px"> Podrobnosti vzorku </span>', "150px");
	...
	if(isImageEnabled)
	{
		specimenTabbar.addTab("imagesTab",'<span style="font-size:13px">Obrázky </span>',"150px");
	}
