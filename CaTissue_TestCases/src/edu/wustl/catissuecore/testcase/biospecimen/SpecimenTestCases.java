...
public class SpecimenTestCases extends CaTissueSuiteBaseTest
{
	...
	public void testSpecimenAdd()
	{
		...
		newSpecForm.setTissueSide("Nespecifikováno") ;
		newSpecForm.setTissueSite("Nespecifikováno");
		newSpecForm.setPathologicalStatus("Nespecifikováno");
		...
		newSpecForm.setClassName("Kapalina");
		newSpecForm.setType("Žluč");
...
/*
	public void testSpecimenEditBySupervisor()
	{
		...
		setRequestPathInfo("/NewSpecimenEdit");
	    addRequestParameter("tissueSide", "Vpravo");
		addRequestParameter("operation", "edit");
		actionPerform();
		verifyForward("success");
		//verify action errors
...
//			verifyForward("success");
	 ...
	 /**
		...
		public void testTissueSpecimenAdd()
		{
			...
			newSpecForm.setClassName("Tkáň");
			newSpecForm.setType("Fixní Tkáň");
			newSpecForm.setQuantity("10") ;
			newSpecForm.setAvailable(true);
			newSpecForm.setAvailableQuantity("5");
		...
		public void testSpecimenAddInRestrictedCont()
		{
			...
			holdsSpecimenClassTypes[0] = "Kapalina";
