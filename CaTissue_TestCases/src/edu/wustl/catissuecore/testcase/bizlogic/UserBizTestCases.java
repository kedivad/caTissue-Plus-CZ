...
//			user = (User) appService.createObject(user);
//			Logger.out.info("User with an empty E-mail");
//			//assertTrue("Cannot enter a User without an E-mail", true);
//
//			fail("Cannot enter a User without an E-mail");
//
//		 }
//		 catch(Exception e)
//		 {
//			 Logger.out.error(e.getMessage(),e);
//			 e.printStackTrace();
//			 assertTrue("Cannot enter User without an E-mail", true);
//
//		 }
//	 }
//
...
//			System.out.println(user);
//			user = (User) appService.createObject(user);
//			Logger.out.info("User with an empty Název Instituce");
