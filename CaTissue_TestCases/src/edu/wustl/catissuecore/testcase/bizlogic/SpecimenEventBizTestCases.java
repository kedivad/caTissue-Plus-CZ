...
public class SpecimenEventBizTestCases extends CaTissueSuiteBaseTest
{
	...
	public void testInsertDisposeSpecimenEvent()
	{
		try
		{
			...
			{
				assertTrue("Disposed event sucessfully fired: Stav Aktivity Closed :" + disposalEvent, true);
			}
			else
			{
	...
	public void testUpdateDisposeSpecimenEventFromClosedToDisabled()
	{
		try
		{
			...
			{
				assertTrue("Disposed event sucessfully fired: Stav Aktivity changed from Closed to Disbled:" + disposalEvent, true);
			}
			else
			{
				assertFalse("Disposed event Failed:" + disposalEvent, true);
	...
	/**
	 * Test case for Insert Zapsání / Odhlášení Event.
	 */
	...
	/**
	 * Test case for updating Zapsání / Odhlášení Event.
	 */
	public void testUpdateCheckInCheckOutEvent()
	{
		try
		{
			...
			{
				assertTrue("Zapsání / Odhlášení event sucessfully fired" + cico, true);
			}
			else
			{
				assertFalse("Zapsání / Odhlášení event Failed:", true);
			}
		}
		catch (Exception e)
		{
			...
			e.printStackTrace();
			assertFalse("Zapsání / Odhlášení event Failed:" + e.getMessage(), true);
		}
	}
