...
//											collectionProtocol);
	...
	public static CollectionProtocolEvent setCollectionProtocolEvent(
		...
		collectionProtocolEvent.setClinicalStatus("Nespecifikováno");
	...
	public static CollectionProtocolEvent getCollectionProtocolEvent(
		...
		while (itr.hasNext()) {
			...
			if ((collectionProtocolEvent.getCollectionPointLabel().trim()
				...
				collectionProtocolEvent.setClinicalDiagnosis("Nespecifikováno");
				collectionProtocolEvent
						.setCollectionProtocol(collectionProtocol);
			}
		}
	...
	private static SpecimenRequirement createSpecimen(
		...
		if (lineage.equals("New")) {
			if (specReq == null) {
				...
				if (ExcelCp[row][7].equals("Tkáň")) {
					specReq = new TissueSpecimenRequirement();
					specReq.setSpecimenClass("Tkáň");
				} else if (ExcelCp[row][7].equals("Kapalina")) {
					specReq = new FluidSpecimenRequirement();
					specReq.setSpecimenClass("Kapalina");
				} else if (ExcelCp[row][7].equals("Buňka")) {
					specReq = new CellSpecimenRequirement();
					specReq.setSpecimenClass("Buňka");
				} else if (ExcelCp[row][7].equals("Molekula")) {
					specReq = new MolecularSpecimenRequirement();
					specReq.setSpecimenClass("Molekula");
				}
			...
			if (ExcelCp[row][17].equals("Tkáň")) {
				specReq = new TissueSpecimenRequirement();
				specReq.setSpecimenClass("Tkáň");
			} else if (ExcelCp[row][17].equals("Kapalina")) {
				specReq = new FluidSpecimenRequirement();
				specReq.setSpecimenClass("Kapalina");
			} else if (ExcelCp[row][17].equals("Buňka")) {
				specReq = new CellSpecimenRequirement();
				specReq.setSpecimenClass("Buňka");
			} else if (ExcelCp[row][17].equals("Molekula")) {
				specReq = new MolecularSpecimenRequirement();
				specReq.setSpecimenClass("Molekula");
			}
	...
	private static void setSpecimenEvents(SpecimenRequirement specReq,
		...
		String collectionEventContainer = "Nespecifikováno";
