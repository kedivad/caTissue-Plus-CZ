...
public class SiteTestCases extends CaTissueSuiteBaseTest
{
	...
	public void testAddRepositorySite()
	{
		...
		addRequestParameter("type","Repozitář");
	...
	{
		RequestParameterUtility.setAddSiteParams(this);
		addRequestParameter("type","Místo sběru");	
		setRequestPathInfo("/SiteAdd");
		actionPerform();
		verifyForward("success");
		verifyNoActionErrors();
	...
	{
		RequestParameterUtility.setAddSiteParams(this);
		addRequestParameter("type","Laboratoř");		
		setRequestPathInfo("/SiteAdd");
		actionPerform();
		verifyForward("success");
		verifyNoActionErrors();
	...
	{
		RequestParameterUtility.setAddSiteParams(this);
		addRequestParameter("type","Nespecifikováno"); 
