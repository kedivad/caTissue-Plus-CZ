 ...
 *	Package:	
 *	Class: 		DAG
 *	Source: 	C:\GitHub\caTissue_Plus_CZ\flexclient\dag\DAG.mxml
...
new mx.core.UIComponentDescriptor({
  ...
  propertiesFactory: function():Object { return {
	...
	public var singleNodecustomFormulaString : String = null;
    ...
    */
    ...
    public  function createAndPopulateSingleNodeTq(queryDataMap : Object, operation : String, customNode : SingleNodeCustomFormulaNode) : void
	{
	     ...
	     else
        {
        	if(operation == "edit" && customNode != null)
        	{
               	...
               	singleNodeTQPope.buttonLabel = "Upravit";
		    ...
		    existingTimeIntervalCb = singleNodeTQPope.myBox.getChildByName("timeIntervalCb") as ComboBox;
		    if((existingTimeIntervalCb!= null) && (customNode.getAtributeName() == "birthDate"))
		    {					
		    	singleNodeTQPope.timeIntervalCb.dataProvider = timeIntervalsBDateDp;
		    	singleNodeTQPope.timeIntervalCb.selectedIndex = 0;
		    }
	...
	public function createAndPopulate(resultMap :Object, operation : String, currentCustomNode : CustomFormulaNode) : void
	{
	  ...
	  else
	  {
	   ...
	   if(operation == "edit" && currentCustomNode != null)
	   {
	        ...
	        // if first attribute is birth/death date then time interval dataprovider should be Year only
		existingTimeIntervalCb = popUp.myBox.getChildByName("timeIntervalCb") as ComboBox;
		if((existingTimeIntervalCb!= null) && (currentCustomNode.getFirstSelectedAttrName() == "birthDate"))
		{					
			popUp.cb5.dataProvider = timeIntervalsBDateDp;
			popUp.cb5..selectedIndex = 0;
		}
	        ...
	        if(currentCustomNode.getSecondSelectedAttrType() == "Integer"){
	         ...
	         // if first attribute is birth/death date then time interval dataprovider should be Year only
		existingTimeIntervalCb = popUp.myBox.getChildByName("timeIntervalCb") as ComboBox;
		if((existingTimeIntervalCb!= null) && (currentCustomNode.getSecondSelectedAttrName() == "birthDate"))
		{					
			popUp.cb5.dataProvider = timeIntervalsBDateDp;
			popUp.cb5.selectedIndex = 0;
		}
	...
	private function populateDataHandler(event :  ResultEvent):void 
	{
	 ...
	 {	 	
	 	...
	 	//customNode.setCustomFormulaString(node.getCustomFormulaString());
      ...
      public function addCustomFromulaNode(node : CustomFormulaNode):void
      {
            ...
            var operation : String = node.getOperation();
            var existingCustomNode : CustomFormulaNode = null;
           // var customNodeDagNodes : Object  = new Object();
           // var dagNodesList : ArrayCollection  = new ArrayCollection();
            ...
            else if(operation == "rePaint")
            {
            	...
            	dagNodesList.addItemAt(dagNode2,1);
            	associatedDAGNodes[customNodeName] = dagNodesList;
            	//getCustomNodeName(dagNode1,dagNode2);
            	//This condition should be  when operation is create or repaint Create
            	/*var nodesName : String = dagNode1.nodeNumber + "_" + dagNode2.nodeNumber; 
	            var cunstomNodeNumber : int = 1;
	            do
	            {
          ...
          /*  for(var key:String in repaintDagNodes)
            {
            	Alert.show("Key is:"+key);
            	var list : ArrayCollection  = repaintDagNodes[key] as ArrayCollection;
            	var dagNode : DAGNode = list[0] as DAGNode ;
            	Alert.show("NOde name is:"+dagNode.name);
            }*/ 
