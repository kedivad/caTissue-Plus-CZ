...
//			this.parentSpecimenName = ''
			...
			this.lineage = '';
			this.specimenClass = 'Buňka';
			this.specimenType = 'Nespecifikováno';
			
			this.tissueSite = 'Nespecifikováno'
			this.tissueSide = 'Nespecifikováno';
			this.pathologicalStatus = 'Nespecifikováno';
		...
		public function validate(isNewSpecimen:Boolean = true):Boolean
		{
			...
			if(isNewSpecimen && mode == MSPParameter.MODE_PARAM_VAL_ADD && this.parentName == "")
			{
				if(this.parentType == "New_Specimen")
					parentNameErrStr = "Zadejte název Skupiny sběru vzorků";
				else
					parentNameErrStr = "Zadejte Label Nadřazeného vzorku";	
			...
			{
				this.specimenLabelErrStr = "Zadejte Label";
				isValid = false && isValid;
			} 
			else
			{
			...
			{
				this.specimenClassErrStr = "Zadejte Třídu vzorku";
				isValid = false && isValid;
			}	
			else
			{
			...
			if(this.specimenType == "" || this.specimenType == Constants.SELECT)
			{
				...
				this.specimenTypeErrStr = "Zadejte Typ vzorku";
				isValid = false && isValid;
			}	
			else
			{
			...
			{
				this.tissueSiteErrStr = "Zadejte Místo odběru tkáně";
				isValid = false && isValid;
			}	
			else
			{
			...
			{
				this.tissueSideErrStr = "Zadejte tissue side";
				isValid = false && isValid;
			}	
			else
			{
			...
			{
				this.pathologicalStatusErrStr = "Vyberte Patologický stav";
				isValid = false && isValid;
			}	
			else
			{
			...
			{
				this.quantityErrStr = "Zadejte Množství";
				isValid = false && isValid;
			}	
			else
			{
						...
						this.specimenType == Constants.MICRODISSECTED || this.specimenType == Constants.NOT_SPECIFIED)))
				{
					...
					{
						this.quantityErrStr = "Zadejte platné Množství";
						isValid = false && isValid;
					}
					else
					{
